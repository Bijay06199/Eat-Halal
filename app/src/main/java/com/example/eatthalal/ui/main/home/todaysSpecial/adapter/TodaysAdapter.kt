package com.example.eatthalal.ui.main.home.todaysSpecial.adapter
...
class TodaysAdapter(private val context: Context, private val listener:OnItemClickListener, var cartItems:ArrayList<NewProductResponseItem>): RecyclerView.Adapter<TodaysAdapter.ViewHolder>(){


    var count: Int = 1
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodaysAdapter.ViewHolder {
