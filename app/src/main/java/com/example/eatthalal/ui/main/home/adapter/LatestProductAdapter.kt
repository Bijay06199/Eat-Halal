...
class LatestProductAdapter (private val listener:OnItemClickListener, var cartItems: List<NewProductResponseItem>,var itemModel: List<CartItemModel>):
...
//            listener.onAddLatestClick(holder.adapterPosition, itemList[holder.adapterPosition])
...
//            listener.onSubtractLatestClick(holder.adapterPosition, itemList[holder.adapterPosition])
////            holder.cart_quantity.setText("" + count--)
//
//
//        }
