package com.example.eatthalal.ui.main.home.latestProducts.adapter
...
class LatestAdapter (private val listener:OnItemClickListener, var cartItems: List<NewProductResponseItem>,var itemModel: List<CartItemModel>):
